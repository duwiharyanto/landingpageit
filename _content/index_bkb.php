  ...
  <div class="main-section" >
	...
	<section class="ftco-section" id="images">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<img src="../img/logo.png" class="text-center" style="display:block;width: 84;height: 84px; margin-right: auto; margin-left:auto;">
					<h2 class="heading-section mb-12 text-center">IT HELPDESK RS UII <br><small>Selmat datang admin</small></h2>
					<div class="row">
						<div class="col-md-2 text-center">
							<a href="http://192.168.30.30/monitoring" target="_blank">
							<img src="../img/icon/master.png" alt="Circle Image" class="mt-5 rounded-circle img-fluid image">
							<h2 class="heading-section mb-4">
								<small>Cloud RSUII</small>
							</h2>
							</a>
						</div>
						<div class="col-md-2 text-center">
							<a href="http://192.168.50.111/owncloud" target="_blank">
							<img src="../img/icon/master.png" alt="Circle Image" class="mt-5 rounded-circle img-fluid image">
							<h2 class="heading-section mb-4">
								<small>OwnCloud</small>
							</h2>
							</a>
						</div>						
						<div class="col-md-2 text-center">
							<a href="http://192.168.50.1:1118" target="_blank">
							<img src="../img/icon/router.png" alt="Circle Image" class="mt-5 rounded-circle img-fluid image">
							<h2 class="heading-section mb-4">
								<small>Router</small>
							</h2>
							</a>
						...
						<div class="col-md-2 text-center">
							...
							<h2 class="heading-section mb-4">
								<small>Grafik Jaringan</small>
							</h2>
							</a>
						</div>
						<div class="col-md-2 text-center">
							<a href="http://192.168.50.111/monitoring" target="_blank">
							<img src="../img/icon/ethernet-on.png" alt="Circle Image" class="mt-5 rounded-circle img-fluid image">
							<h2 class="heading-section mb-4">
						...
						<div class="col-md-2 text-center">
							<a href="https://netstat.uii.net.id/" target="_blank">
							<img src="../img/icon/area-chart.png" alt="Circle Image" class="mt-5 rounded-circle img-fluid image">
							<h2 class="heading-section mb-4">
								<small>Netstat</small>
							</h2>
						...
						<div class="col-md-2 text-center">
							<a href="https://192.168.50.111/portal" target="_blank">
							<img src="../img/icon/web-design.png" alt="Circle Image" class="mt-5 rounded-circle img-fluid image">
							<h2 class="heading-section mb-4">
								<small>Konten Lokal</small>
							</h2>
							</a>
						</div>
						<div class="col-md-2 text-center">
